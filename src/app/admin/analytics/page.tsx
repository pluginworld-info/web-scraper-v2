...
export default function AnalyticsPage() {
  ...
  if (loading) return <div className="text-[#666] animate-pulse">Loading Intelligence...</div>;
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-[#666] font-medium mt-1">Breakdown of clicks by retailer and product performance.</p>
      </div>
